...
const DRIVER_WITHDRAWAL_FEE_FLAT = Number(process.env.DRIVER_WITHDRAWAL_FEE_FLAT || 0);
const DRIVER_WITHDRAWAL_FEE_RATE = Number(process.env.DRIVER_WITHDRAWAL_FEE_RATE || 0);

const DRIVER_SEARCH_RADIUS_KM = Number(process.env.DRIVER_SEARCH_RADIUS_KM) || 10;

const OFFER_EXPIRY_MS = Number(process.env.OFFER_EXPIRY_MS || 10 * 60 * 1000);
